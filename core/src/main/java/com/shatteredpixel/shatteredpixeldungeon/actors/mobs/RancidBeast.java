...
import com.shatteredpixel.shatteredpixeldungeon.sprites.RancidBeastSprite;
import com.shatteredpixel.shatteredpixeldungeon.sprites.CharSprite;
import com.shatteredpixel.shatteredpixeldungeon.utils.GLog;
import com.watabou.utils.Bundle;
import com.watabou.utils.Random;

public class RancidBeast extends Mob {
{
		spriteClass = RancidBeastSprite.class;
	...
	public int attackProc( Char enemy, int damage ) {
		...
		// stun
			if(Random.Int(0,10)>7){
				...
				GLog.n("The Rancid Beast kicks you in the chest, chockes you of your breath!");
			}
		return damage;
	}
	@Override
