...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.GaunletDagger;
...
public enum HeroClass {
	...
	//	tass.identify();
		...
		Item food1 = new SlowRoastedRat();
		food1.collect();
		Item test = new ScrollOfMagicMapping();
		test.quantity = 99;
		test.collect();


		Item test2 = new WandOfDisintegration();
		test2.collect();
		test2.identify();
		test2.level =100;
		Item test3 = new RingOfEnergy();
		test3.level =100;
		test3.identify();
		test3.collect();
		ScrollOfMagicalInfusion up = new ScrollOfMagicalInfusion();
		up.quantity =10;
		up.collect();

		Garlic g = new Garlic();
		g.collect();
		ChicoryRoot r = new ChicoryRoot();
		r.collect();
		Mandrake ma = new Mandrake();
		ma.collect();



		Item foodBag = new FoodPouch();
		foodBag.collect();
