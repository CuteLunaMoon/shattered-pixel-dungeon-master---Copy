...
import com.shatteredpixel.shatteredpixeldungeon.levels.features.Shrub;
...
public class Hero extends Char {
	...
	public static final int STARTING_SKL = 0;
...
public int CookingSKill(){return  CookingSkill;}
public int bloodUsed(){return  bloodUsed;}
	...
	private static final String BLOOD = "BLOOD"; // how many blood vials were used?
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( SKILL, SKL );
		bundle.put( ARCANE, ARC );
		bundle.put(COOK, CookingSkill);
		bundle.put (BLOOD, bloodUsed);
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		SKL = bundle.getInt( SKILL );
		ARC = bundle.getInt( ARCANE );
		CookingSkill = bundle.getInt(COOK);
		bloodUsed = bundle.getInt(BLOOD);
	...
	public boolean act() {
		...
		if (curAction == null) {
			...
			if( curAction instanceof HeroAction.Forage ){

				return actForage( (HeroAction.Forage) curAction );
	...
	public void checkVisibleMobs() {
	 ...
	 private boolean actExamine( HeroAction.Examine action ){
        ...
        int dest = action.dst;
        if(Dungeon.level.adjacent( pos, dest ) ){
	...
	private boolean actForage( HeroAction.Forage action ){
	...
	public boolean handle( int cell ) {
		...
		}else if( Dungeon.level.map[ cell ] == Terrain.SHRUB_BERRIES ){

			curAction = new HeroAction.Forage( cell );
	...
	public void onOperateComplete() {
		...
		}else if( curAction instanceof HeroAction.Forage ){

			int cell = ( (HeroAction.Forage) curAction ).dst;
