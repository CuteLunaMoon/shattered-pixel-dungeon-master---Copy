...
public class ItemSpriteSheet {
	...
	public static final int WILD_CARROT 	= UNCOLLECTIBLE+7;
	public static final int BURDOCK_ROOT	= UNCOLLECTIBLE+8;
	...
	static{
		...
		assignItemRect(TINDER,  10, 11);
		assignItemRect(WILD_CARROT,  15, 13);
		assignItemRect(BURDOCK_ROOT,  15, 13);
	}
	...
	public static final int SHOVEL          = WEP_TIER2+5;
	static{
	...
	public static final int GAUNTLETDAGGER       = WEP_TIER5+6;
	static{
		...
		assignItemRect(GAUNTLETDAGGER,   13, 15);
	}
	...
	public static final int MED_KIT 			= ARTIFACTS+24;
	public static final int MOLOTOV 			=ARTIFACTS+25;
	static{
	...
	public static final int SCROLL_JAGER   	= SCROLLS+13;
	public static final int SCROLL_ERBE   	= SCROLLS+14;
	static {
	...
	public static final int CHICORY = QUEST+7;//food, not quest items
	public static final int MANDRAKE = QUEST+8;
	public static final int GARLIC 	= QUEST+9;
	public static final int SLOWROAST 	= QUEST+10;
	public static final int FRIEDROOT 	= QUEST+11; //BURDOCK
	public static final int BAKEDROOT 	= QUEST+12;
	public static final int FRIEDCARROT 	= QUEST+13;//CARROT
	public static final int BAKEDCARROT 	= QUEST+14;
	public static final int BAKEDCHICORY 	= QUEST+15;//CHICORY
	...
	static{
		...
		assignItemRect(CHICORY, 16,16);
		assignItemRect(MANDRAKE, 16,16);
		assignItemRect(GARLIC, 16,16);
		assignItemRect(SLOWROAST, 16,16);
		assignItemRect(FRIEDROOT, 16,16);
		assignItemRect(BAKEDROOT, 16,16);
		assignItemRect(FRIEDCARROT, 16,16);
		assignItemRect(BAKEDCARROT, 16,16);
		assignItemRect(BAKEDCHICORY, 16,16);
	}
	
	private static final int FOOD2  =                                       xy(1, 27); 
	public static final int BLOODSAUSAGE 	= FOOD2+0;
	public static final int HUNTERSOUP 	= FOOD2+1;//CHICORY
	
	
	
	
	static{
		assignItemRect(BLOODSAUSAGE,   16, 16);
		assignItemRect(HUNTERSOUP,    16, 16);
		}
	...
	private static final int MATERIAL  =                                       xy(1, 29); 
	public static final int BLOODSTONE 	= MATERIAL+0;
	public static final int DIRTYBLOODSTONE 	= MATERIAL+1;//CHICORY
	public static final int SPARKLINGBLOODSTONE 	= MATERIAL+2;//CHICORY
	public static final int COLDBLOODSTONE 	= MATERIAL+3;//CHICORY
	static{
		assignItemRect(BLOODSTONE,        16, 16);
		assignItemRect(DIRTYBLOODSTONE,       16, 16);
		assignItemRect(SPARKLINGBLOODSTONE,      16, 16);
		assignItemRect(COLDBLOODSTONE,     16, 16);
	}
	
	
	
	static{
		assignItemRect(BLOODSAUSAGE,   16, 11);
		assignItemRect(HUNTERSOUP,    12, 11);
		}
