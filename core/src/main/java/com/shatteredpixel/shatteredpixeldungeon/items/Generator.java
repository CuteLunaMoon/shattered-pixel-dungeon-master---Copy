...
import com.shatteredpixel.shatteredpixeldungeon.items.armor.RivettedMailArmor;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.MunitionArmor;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.JoustArmor;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.Gambeson;
...
import com.shatteredpixel.shatteredpixeldungeon.items.scrolls.ScrollOfRaiseSkeleton;
...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Arbalest;
	...
	public enum Category {
		...
		static {
			...
			WEP_T2.classes = new Class<?>[]{
					...
					Quarterstaff.class,
					Dirk.class,
					PelletCrossbow.class
			};
			WEP_T2.probs = new float[]{ 6, 5, 5, 4, 4,5 };
			...
			ARMOR.classes = new Class<?>[]{
					...
					ScaleArmor.class,
					PlateArmor.class,
					RivettedMailArmor.class, Gambeson.class, MunitionArmor.class, JoustArmor.class
					 };
			ARMOR.probs = new float[]{ 0, 0, 0, 0, 0,0,0,0,0 };
