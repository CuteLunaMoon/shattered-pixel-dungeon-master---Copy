...
public class InterlevelScene extends PixelScene {
	...
	public void create() {
		...
		else if (loadingDepth <= 16)    loadingAsset = Assets.LOADING_CAVES;
		else if (loadingDepth <= 21)    loadingAsset = Assets.LOADING_SEWERS;
		else if (loadingDepth <= 27)    loadingAsset = Assets.LOADING_CAVES;
		else if (loadingDepth <= 32)    loadingAsset = Assets.LOADING_CITY;
		else if (loadingDepth <= 39)    loadingAsset = Assets.LOADING_HALLS;
