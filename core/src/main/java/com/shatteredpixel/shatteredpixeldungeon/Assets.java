...
public class Assets {
	...
	public static final String RAT			= "rat.png"; //Oleg's
	...
	public static final String ROT_LASH 		= "rot_lasher.png"; //Evan's
	public static final String ROT_HEART		= "rot_heart.png";
	public static final String GUARD    		= "guard.png";
	public static final String GOBLIN  				= "Goblin.png"; //Luna's
	public static final String HUNTSMAN  			= "HuntsmanBareHand.png";
	public static final String SKULL_SHAMAN 		= "SkullShaman.png";
	public static final String INN 					= "InnKeeper.png";
	public static final String URTA 				= "UrtaNPC.png";
	public static final String LANTERN_GUY 			= "LanternGuy.png";
	public static final String TORCH_HUNTSMAN  		= "TorchHuntsman.png";
	public static final String SHIELD_HUNTSMAN 		= "ShieldHuntsman.png";
	public static final String POLTERGEIST 			= "BlackGhost.png";
	public static final String CAPTAIN 				="GuardCaptain.png";
	public static final String CULTIST				= "Cultist.png";
	public static final String BROWN_BAT 			="BrownBat.png";
	public static final String SWORD_HUNTSMAN 		="SwordHuntsman.png";
	public static final String L_SWORD_HUNTSMAN 	="LargeHuntsman.png";
	public static final String DOCTOR_IO 			="Doctor.png";
	public static final String WALKING_MUSHROOM 	= "WalkingMushroom.png";
	public static final String WALKING_MUSHROOM2 	= "WalkingMushroom2.png";
	public static final String BEAST 				="RancidBeast.png";
	public static final String MINISTER				= "BloodMinister.png";
	public static final String NULL 				= "Null.png";
	public static final String LEECH 				="LeechCollector.png";
	public static final String LEECH_SPAWN 			="Leech.png";
	public static final String MOSQUITO 			= "MosquitoSwarm.png";
