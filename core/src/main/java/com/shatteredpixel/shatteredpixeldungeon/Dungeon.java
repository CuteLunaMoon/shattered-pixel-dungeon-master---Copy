...
import com.shatteredpixel.shatteredpixeldungeon.levels.CavesLevel2;
...
*/
	...
	public static int residentNumber;
	...
	private static final String RESIDENCENUMBER =	"residenceNumber";
	...
	public static void saveGame( int save ) throws IOException {
		try {
			...
			bundle.put(RESIDENCENUMBER,residentNumber);
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		if (fullLoad) {
			...
			if (!quests.isNull()) {
				...
				GuardCaptain.Quest.restoreFromBundle(quests);
			} else {
				Ghost.Quest.reset();
				Wandmaker.Quest.reset();
				Blacksmith.Quest.reset();
		...
		residentNumber = bundle.getInt(RESIDENCENUMBER);
