...
public class DungeonTileSheet {
	...
	public static final int DOOR_SP 			= FLAT_DOORS+5;
	public static final int DOOR_SP2			= FLAT_DOORS+6;
	public static final int DOOR_SP3 			= FLAT_DOORS+7;
	...
	public static final int SHRUB =     FLAT_OTHER+8;
	public static final int SHRUB_BLOOM =   FLAT_OTHER+9;
	public static final int SHRUB_BERRIES =     FLAT_OTHER+10;
...
//	public static final int RAISED_WALL_BOOKSHELF_ALT   = RAISED_WALLS+28;
	//public static final int RAISED_BOOKSHELF_EMPTY       = FLAT_WALLS+7;
	...
	static {
		...
		directVisuals.put(Terrain.DOOR_SP,           DOOR_SP);
		directVisuals.put(Terrain.DOOR_SP2,           DOOR_SP2);
		directVisuals.put(Terrain.DOOR_SP3,           DOOR_SP3);
		...
		directVisuals.put(Terrain.SHRUB,      		 SHRUB);
		directVisuals.put(Terrain.SHRUB_BLOOM,       SHRUB_BLOOM);
		directVisuals.put(Terrain.SHRUB_BERRIES,     SHRUB_BERRIES);
	...
	static {
		...
		directFlatVisuals.put(Terrain.SHRUB,      		 SHRUB);
		directFlatVisuals.put(Terrain.SHRUB_BLOOM,       SHRUB_BLOOM);
		directFlatVisuals.put(Terrain.SHRUB_BERRIES,     SHRUB_BERRIES);
