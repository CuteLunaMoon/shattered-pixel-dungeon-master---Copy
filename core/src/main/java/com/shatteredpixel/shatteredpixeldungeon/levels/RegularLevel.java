...
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.Clinic;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.GardenRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.Inn;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.PitRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.ShopRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.SpecialRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.standard.EntranceRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.standard.ExitRoom;
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.InhabitantRoom;
...
public abstract class RegularLevel extends Level {
	...
	protected ArrayList<Room> initRooms() {
		...
		if(Dungeon.gardenOnLevel()) {
			initRooms.add(new GardenRoom());
			initRooms.add(new GardenRoom());
		}
		if (Dungeon.clinicLevel()) {
			initRooms.add(new Clinic());
			initRooms.add(new Inn());

		}

		if(Dungeon.residenceLevel()){
			initRooms.add(new InhabitantRoom());
			initRooms.add(new InhabitantRoom());
			initRooms.add(new InhabitantRoom());
		//	initRooms.add(new InhabitantRoom());
		//	initRooms.add(new InhabitantRoom());
