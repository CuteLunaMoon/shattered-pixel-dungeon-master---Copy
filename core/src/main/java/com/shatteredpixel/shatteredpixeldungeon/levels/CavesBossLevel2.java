	...
	public String tileDesc( int tile ) {
		switch (tile) {
			...
			case Terrain.BOOKSHELF:
				return Messages.get(CavesLevel.class, " The shelf is full of strange books: necromancy, demonology, how to summon a succubus, how to pick up fair maiden. Even more strange, most of them are written in the common tongue, not Drawven. ");
			default:
