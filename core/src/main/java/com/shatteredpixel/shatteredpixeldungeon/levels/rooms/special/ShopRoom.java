...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		case 1: 
			...
			itemsToSpawn.add( new LeatherArmor().identify() );
				itemsToSpawn.add( new Gambeson().identify() );
			break;
			case 2:
	...
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
		itemsToSpawn.add( new ScrollOfMagicalInfusion() );
		itemsToSpawn.add( new ScrollOfMagicalInfusion() );
		itemsToSpawn.add( new MunitionArmor().identify() );
		...
		case 5:
			itemsToSpawn.add( new ScrollOfMagicalInfusion() );
			itemsToSpawn.add( new RivettedMailArmor().identify() );
		case 11:
		...
		case 16:
			...
			itemsToSpawn.add( new JoustArmor().identify() );
