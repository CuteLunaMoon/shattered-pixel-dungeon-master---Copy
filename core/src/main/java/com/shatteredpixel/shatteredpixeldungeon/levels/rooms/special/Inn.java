...
public class Inn extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		itemsToSpawn.add(new Pasty());
		itemsToSpawn.add(new Pasty());
		itemsToSpawn.add(new TenderRoastedBabyCarrots());
		itemsToSpawn.add(new SpicedSauteeBurdockRoot());
